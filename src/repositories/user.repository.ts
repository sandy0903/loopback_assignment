...
import {User, UserRelations, Projectuser, Project,Usercredentials, Task} from '../models';
...
> {
  ...
  constructor(
    ...
    @repository.getter('UsercredentialsRepository') protected usercredentialsRepositoryGetter: Getter<UsercredentialsRepository>, @repository.getter('TaskRepository') protected taskRepositoryGetter: Getter<TaskRepository>,
  ) {
